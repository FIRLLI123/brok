            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        ...
                        <form action="{{ route('user.kost.index') }}" method="GET" class="space-y-4">
                            <div class="flex flex-wrap gap-4">
                                ...
                                <!-- Reset Button -->
                                @if(request()->hasAny(['search', 'city', 'min_price', 'max_price', 'status']))
                                    <a href="{{ route('user.kost.index') }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @forelse($kosts as $kost)
                            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow cursor-pointer">
                                <a href="{{ route('user.kost.show', $kost) }}" class="block">
                                    ...
                                    <div class="p-4">
                                        <h3 class="text-lg font-semibold mb-2 text-gray-900 hover:text-indigo-600">{{ $kost->name }}</h3>
                                        <p class="text-gray-600 mb-2">{{ $kost->city }}</p>
                                        <p class="text-gray-600 mb-4">{{ Str::limit($kost->description, 100) }}</p>
