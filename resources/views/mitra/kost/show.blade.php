                ...
                <div class="p-6 md:p-10">
                    ...
                    <div class="mb-8 flex items-center justify-between">
                        ...
                        <!-- <div class="flex gap-3">
                            <a href="{{ route('mitra.rooms.create', ['kost_id' => $kost->id]) }}" class="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition duration-150 ease-in-out text-base font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="space-y-4 px-2 md:px-4 pb-2 md:pb-4">
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 leading-tight mb-3">{{ $kost->name }}</h1>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6 text-gray-700">
                            ...
                            <div class="flex items-center text-blue-700 font-bold text-xl col-span-full mt-3">
                                ...
                                <span>Rp {{ number_format($kost->price, 0, ',', '.') }}/bulan</span>
                            </div>
                        </div>

                        <div class="mt-6 pt-4 border-t border-gray-200">
                            <h2 class="text-xl font-bold text-gray-800 mb-3">Deskripsi Kost</h2>
                            <p class="text-gray-700 leading-relaxed text-base">{{ $kost->description }}</p>
                        </div>
                        ...
                        <div class="mt-8 pt-4 border-t border-gray-200">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="{{ route('mitra.rooms.create', ['kost_id' => $kost->id]) }}" 
                                    ...
                                    @foreach($kost->rooms as $room)
                                        <div class="flex justify-between items-start p-4 bg-gray-50 rounded-lg border border-gray-200 gap-4">
                                            ...
                                            <div class="flex gap-2 flex-shrink-0 items-center">
                                                ...
                                                <form action="{{ route('mitra.rooms.destroy', $room) }}" method="POST" 
