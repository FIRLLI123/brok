    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded shadow">
                ...
                <form id="kostForm" action="<?php echo e(route('mitra.kost.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Brock\resources\views/mitra/kost/create.blade.php ENDPATH**/ ?>